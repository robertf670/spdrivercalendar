...
void main() {
  testWidgets('fits 320px and adds the selected overtime shift', (tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: OvertimeDutyDetailsDialog(
    ...
    expect(find.textContaining('Add Overtime Duty'), findsOneWidget);
    expect(find.text('01A'), findsOneWidget);
    expect(loadedZones, ['Zone 1']);

    await tester.tap(find.text('Add Overtime Shift'));
    await tester.pumpAndSettle();
