      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildStatRow('Total Shifts', '${(stats['totalShifts'] ?? 0) + (stats['overtimeShifts'] ?? 0)}'),
            ...
            _buildStatRow('Universal/Euro Shifts', '${stats['uniEuroShifts'] ?? 0}'),
            _buildStatRow('Overtime Shifts', '${stats['overtimeShifts'] ?? 0}'),
            _buildStatRow('Work For Others', '${stats['workForOthersShifts'] ?? 0}'),
